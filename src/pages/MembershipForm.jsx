...
function PrintView({ form }) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          <div>
            ...
            <div style={{ fontSize: 10 }}>
              Tel.: +91 9447093119, Email: cgikoramangala@gmail.com
            </div>
          </div>
        </div>
      </div>
      ...
      <Row
        label="If yes, transferring from which church?"
    ...
    <div className="min-h-screen bg-[#dae1e3] text-black">
      ...
      <div className="bg-white shadow-sm mb-6 sm:mb-10">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-5 text-center">
          <p className="text-xs sm:text-sm font-semibold tracking-widest text-blue-500 uppercase mb-1">
            Join the Body of Christ
          </p>
          <h1 className="text-3xl sm:text-4xl font-serif text-blue-900 mb-4">
            Church Membership
          </h1>
          ...
          <p className="text-sm text-gray-600 max-w-2xl mx-auto leading-relaxed font-semibold">
            ...
            grow in the knowledge and grace of our Lord Jesus Christ.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto bg-[#ebe6cc] shadow-md mb-10">
        ...
        <div className="text-center py-4 px-4 border-b-2 border-gray-800">
          <div className="flex items-center justify-center gap-3">
            ...
            <div className="text-left">
              ...
              <p className="text-xs text-gray-600 hidden sm:block">
                # 418, 80ft Road, 6th Block, Koramangala, Bangalore - 560 095
              </p>
              <p className="text-xs text-gray-600 hidden sm:block">
                Tel.: +91 9447093119 | cgikoramangala@gmail.com
              </p>
            </div>
          </div>
          ...
          <div className="sm:hidden mt-2 text-xs text-gray-500 space-y-0.5">
            ...
            <p>Tel.: +91 9447093119 | cgikoramangala@gmail.com</p>
          </div>
        </div>
        ...
        <div className="p-4 sm:p-6 space-y-5">
          ...
          <div className="border border-gray-300 rounded-md p-3 text-sm space-y-1">
            <p>
              ➤ <strong>Do you want to become a member of our church?</strong>
            </p>
            <p>
              ➤{" "}
              <strong>
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <Field label="Date of Faith Baptism">
                <DateInput
                  value={form.baptismDate}
                  onChange={(e) => set("baptismDate", e.target.value)}
                />
              </Field>
              <Field label="Baptized Under Which Church">
                <TextInput
            ...
            <Field label="Are you baptized in the Holy Spirit?">
              <RadioGroup
                options={["Yes", "No"]}
                value={form.holySpiritBaptized}
                onChange={(v) => set("holySpiritBaptized", v)}
              />
            </Field>
            <Field label="Date of Holy Spirit Baptism">
              <DateInput
                value={form.holySpiritDate}
                onChange={(e) => set("holySpiritDate", e.target.value)}
              />
            </Field>
            <Field label="Date from which you are attending this church">
              <DateInput
          ...
          <div className="space-y-4">
            <Field label="Would you like to transfer your membership to this church?">
              <RadioGroup
                options={["Yes", "No"]}
                value={form.transferMembership}
                onChange={(v) => set("transferMembership", v)}
              />
            </Field>
            ...
            <Field label="Were you ever a member of any Pentecostal church?">
              <RadioGroup
                options={["Yes", "No"]}
                value={form.pentecostalMember}
                onChange={(v) => set("pentecostalMember", v)}
              />
            </Field>
            ...
            <Field label="Have you understood the doctrine of CGI?">
              <RadioGroup
                options={["Yes", "No"]}
                value={form.understoodDoctrine}
                onChange={(v) => set("understoodDoctrine", v)}
              />
            </Field>
          ...
          <div>
            <SectionHeader
              ...
              subtitle="(To be completed by the Head of the Family)"
            />
          ...
          <div className="border border-gray-200 rounded-md p-4 bg-gray-50">
            <p className="text-center font-bold text-sm mb-3 tracking-wide">
              DECLARATION
            </p>
          ...
          <div className="mt-4">
            ...
            <div className="sm:hidden border border-gray-300 rounded-md mt-2">
              {[
                ...
                >
                  <span className="text-xs font-bold text-gray-600 p-2 w-36 border-r border-gray-200 bg-gray-50">
                    {h}
                  </span>
