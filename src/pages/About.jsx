...
const About = () => {
  ...
  const doctrinaalCommitments = [
    ...
    },
    {
      ...
      scripture: "1 Thessalonians 5:23; 1 Corinthians 6:11; 1 Corinthians 1:30; 1 Thessalonians 4:3; Hebrews 13:12"
    },
    {
      title: "Holiness",
    ...
    },
    {
      ...
      description: "subsequent to cleansing; the enduement of power for service",
    ...
    },
    {
      ...
      scripture: "Romans 6:22; Galatians 5:22, 23; Ephesians 5:9; Philippians 1:11"
    },
    {
      title: "Divine Healing",
      scripture: "Isaiah 53:4, 5; Matthew 8:16, 17; Mark 16:18; James 5:14, 15; 1 Peter 2:24"
    },
    {
    ...
    },
    {
      ...
      scripture: "Genesis 14:18-20; Hebrews 7:8; Malachi 3:10; Luke 11:42; 1 Corinthians 16:2; 2 Corinthians 9:6-7; 2 Corinthians 8:12"
    },
    {
      title: "Restitution",
    ...
    },
    {
      ...
      description: "First, to resurrect the dead saints and to catch away the living saints to Him in the air. Second, to reign on the earth a thousand years",
      scripture: "1 Thessalonians 4:15-17; 1 Corinthians 15:51-52; Zechariah 14:4; 1 Thessalonians 4:14-2; Thessalonians 1:7-10; Jude 14, 15; Revelation 5:10; 19:11-21; 20:4-6"
    },
    {
    ...
    },
    {
      ...
      scripture: "Matthew 25:46; Luke 18:30; John 10:28; Romans 6:22; 1 John 5:11-13"
    },
    {
      title: "Eternal punishment for the wicked",
      description: "No liberation nor annihilation",
      scripture: "Matthew 25:41-46; Mark 3:29; 2 Thessalonians 1:8, 9; Revelation 20:10, 15; 21:8"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative bg-[#F7F3E7] text-white py-20 px-4">
        <div className="absolute inset-0 bg-black bg-opacity-30"></div>
        <div className="relative z-10 container mx-auto max-w-4xl text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-8">ABOUT US</h1>
          <div className="space-y-4 text-lg leading-relaxed">
            <p>
              Koramangala Church of God (Bangalore, Karnataka, India) is a part of the Church of God in India, under 
              Church of God (Cleveland, Tennessee).
            </p>
            <p>
              Our church is dedicated to worshipping God, reaching people for Christ, building relationships, sharing 
              the love of God and equipping believers to minister through the power of the Holy Spirit.
            </p>
            <p>We welcome you to be a part of this church because...</p>
            <p>We believe you matter to God and we want to help you know Jesus Christ.</p>
            <p>We believe church to be a place of grace and we want to help you know the community.</p>
            <p>We believe that you should live like Jesus and we want to help you grow in him.</p>
            <p>We believe you have a purpose and we want to help you identify it.</p>
            <p className="font-semibold">
              The Koramangala Church of God is headed by Pastor Nebu Vohanan
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="py-16 px-4 bg-gray-50">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold text-gray-800 mb-4">OUR BELIEF</h2>
          </div>
      ...
      <div className="py-16 px-4 bg-white">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold text-gray-800 mb-4">DOCTRINAL COMMITMENTS</h2>
          </div>
          
          <div className="bg-gray-50 p-8 rounded-lg">
            <p className="text-gray-700 leading-relaxed mb-8">
              The following Doctrinal Commitments represent the core beliefs of the denomination as outlined in 
              Scripture:
            </p>
      ...
      <div className="py-16 px-4 bg-gray-50">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold text-gray-800 mb-4">DECLARATION OF FAITH</h2>
          </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow-sm">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-4">We Believe:</h3>
      ...
      <div className="py-16 px-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg mb-8 opacity-90">
            We invite you to become part of our church family and experience God's love in a welcoming community.
          </p>
